				...
				<div class="card card-container">
					<form class="form-signin form">					
						...
						<div class="form-group">
							...
							<!-- <button class="btn btn-lg btn-primary btn-block btn-signin" ng-click="doLoginFacebook('<?php echo FL_URL?>')">Đăng nhập Facebook</button> -->
							<button class="btn btn-lg btn-primary btn-block btn-signin" ng-click="doLoginGoogle('<?php echo FL_URL?>')">Đăng nhập Google</button>
						</div>
					</form><!-- /form -->
